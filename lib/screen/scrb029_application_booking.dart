...
class Scrb029ApplicationBooking extends StatefulWidget {
  const Scrb029ApplicationBooking({Key? key}) : super(key: key);

  @override
  _Scrb029ApplicationBookingState createState() => _Scrb029ApplicationBookingState();
}

class _Scrb029ApplicationBookingState extends State<Scrb029ApplicationBooking> {
  Map arguments = {};
