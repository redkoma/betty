...
class Scrb007EditDepartment extends StatefulWidget {
  const Scrb007EditDepartment({Key? key}) : super(key: key);

  @override
  _Scrb007EditDepartmentState createState() => _Scrb007EditDepartmentState();
}

class _Scrb007EditDepartmentState extends State<Scrb007EditDepartment> {
  Map arguments = {};
