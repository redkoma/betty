...
class Scrb019CheckIn extends StatefulWidget {
  const Scrb019CheckIn({Key? key}) : super(key: key);

  @override
  _Scrb019CheckInState createState() => _Scrb019CheckInState();
}

class _Scrb019CheckInState extends State<Scrb019CheckIn> {
  Map arguments = {};
  ...
  Widget build(BuildContext context) {
    ...
    if (!loaded) {
      ...
      if (obj['data']['in'] == null) {
        ...
        AppStyle().session['location'] = LatLng(obj['data']['in_location']['lat'], obj['data']['in_location']['lng']);

        time = obj['data']['in'].toDate();
      }
      setState(() {});
    }
      ...
      body: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
          ...
          ListTile(
            ...
            trailing: (obj['data']['in'] == null) ? ((obj['images'] != null) ? Image.file(File(obj['images'].path)) : null) : Image.network(obj['data']['in_photo']),
            onTap: (obj['data']['in'] == null)
                ? () async {
