...
class Scrb043FormTraining extends StatefulWidget {
  const Scrb043FormTraining({Key? key}) : super(key: key);

  @override
  _Scrb043FormTrainingState createState() => _Scrb043FormTrainingState();
}

class _Scrb043FormTrainingState extends State<Scrb043FormTraining> {
  Map arguments = {};
...
//      calcTimesheetStat(myyear, mymonth);
      ...
      if (obj['doc']['data']['create_date'] == null) {
        ...
        if (obj['doc']['data']['training_date'] == null) {
          training_date = DateTime(create_date.year, create_date.month, create_date.day + 1);
          expense_amount = 0;
        } else {
          if (obj['doc']['data']['training_date'] is DateTime) {
            training_date = obj['doc']['data']['training_date'];
          } else {
            obj['doc']['data']['training_date'] = obj['doc']['data']['training_date'].toDate();
            training_date = obj['doc']['data']['training_date'];
          }
        }
      }
      ...
      if (obj['doc']['data']['training_type'] != null) {
        training_type = obj['doc']['data']['training_type'];
      } else {
        training_type = AppStyle().session['company']['training_type'][0]['name'];
      }

      if (obj['doc']['data']['remark'] != null) {
        training_remark = obj['doc']['data']['remark'];
        remarkController.text = training_remark;
      }
        ...
        actions: [
          IconButton(
              onPressed: () async {
                ...
                var l2uid = AppStyle().session['company']['training_confirm_user']['userinfo']['uid'];
                AppStyle().session['company']['training_confirm_username'] =
                    AppStyle().session['company']['members'][l2uid]['userinfo']['displayName'] ?? AppStyle().session['company']['members'][l2uid]['userinfo']['email'];
                AppStyle().session['company']['training_confirm_user'] = AppStyle().session['company']['members'][l2uid];
                print(AppStyle().session['company']['training_confirm_username']);
                setState(() {});
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: Image.asset(
                                    "assets/images/training_setting_001.png",
                              ...
                              ListTile(
                                leading: CircleAvatar(
                                  radius: 24,
                                  backgroundImage: NetworkImage("${AppStyle().session['company']['training_confirm_user']['userinfo']['photoURL'] ?? AppStyle().no_user_url}"),
                                ),
                                title: Text(
                                  "Training Confirm User",
                                ),
                                subtitle: Text(
                                  "${AppStyle().session['company']['training_confirm_username'] ?? ''}",
                                ),
                ...
                } else if ((obj['doc']['status'] == 'Wait for Confirm') && (AppStyle().session['data']['uid'] == obj['doc']['data']['approver2'])) {
                  // Owner view on Status is not set
                  // Save or Send & Preview Flow
                  res = await showModalBottomSheet(
                      isScrollControlled: true,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        Navigator.pop(context, {'action': 'ConfirmApprove'});
                                      },
                                    ),
                                    ElevatedButton(
                                      style: ElevatedButton.styleFrom(primary: Colors.red, fixedSize: Size((MediaQuery.of(context).size.width - 40) * 0.5, AppStyle().btnHeight)),
                                      ...
                                      onPressed: () async {
                                        Navigator.pop(context, {'action': 'ConfirmReject'});
                                      },
                                    ),
                                  ],
                                ),
                ...
                if (res != null) {
                  ...
                  obj['doc']['data']['training_type'] = training_type;
                  obj['doc']['data']['training_date'] = training_date;
                  // obj['doc']['data']['expense_amount'] = expense_amount;
                  obj['doc']['data']['remark'] = training_remark;
                  ...
                  if (res['action'] == 'Send') {
                    ...
                    obj['doc']['data']['approver2'] = AppStyle().session['company']['training_confirm_user']['uid'];
                    obj['doc']['data']['approver2info'] = AppStyle().session['company']['training_confirm_user']['userinfo'];

                    // Case Requester is Manager and not
                    if (obj['doc']['data']['approver1'] == AppStyle().session['data']['uid']) {
                      obj['doc']['status'] = "Wait for Confirm";
                  ...
                  if (res['action'] == 'ConfirmReject') {
                    obj['doc']['status'] = "Confirm Rejected";
                  ...
                  if (res['action'] == 'ConfirmApprove') {
                    obj['doc']['data']['training_date'] = FieldValue.serverTimestamp();

                    obj['doc']['status'] = "Confirm Approved";
                  ...
                  if (obj['doc']['status'] != null) {
                    if ((obj['doc']['data']['approver1'] ?? '') != '') {
                      ...
                      await FirebaseFirestore.instance.collection('inbox').doc("${obj['doc']['id']}-${obj['doc']['data']['approver1']}").set({
                        ...
                        'subtitle': '${obj['doc']['data']['training_type']}',
                        'status': obj['doc']['status'],
                        'status_color': '',
                      });
                    }
                    // if status is send to Confirm then add inbox Confirm
                    ...
                    if (obj['noti'] != null) {
                      ...
                      var payload = {
                        'FCM': FCM,
                        'uid': obj['noti'],
                        'title': 'มีใบขออบรมรอพิจารณา',
                        'body': '${obj['doc']['data']['training_type']}',
                        'data': {
                          'body': '${obj['doc']['data']['training_type']}',
                          'action': 'training',
                          'did': obj['doc']['id'],
                        ...
                        Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // SizedBox(height: 3),
                                Text(
                                  '${DateFormat("dd MMM yyyy").format(training_date)}',
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  subtitle: Text(
                    "${DateFormat("dd MMMM yyyy HH:mm").format(training_date)}",
                  ),
                  ...
                  onTap: (readonly)
                      ...
                      : () async {
                          var res = await Navigator.pushNamed(context, '/util101', arguments: {
                            ...
                            'title': 'วันที่อบรม',
                            'datetime': 'Y',
                            'barcolor': Color.fromARGB(255, 27, 35, 140),
                          });
                          if (res != null) {
                            var tmp = res as DateTime;

                            training_date = res as DateTime;
                            obj['doc']['data']['training_date'] = training_date;
                            setState(() {});
                          }
                        },
                ...
                //       ? null
                //       : () async {
                //           var res = await AppStyle().confirmData(context, expense_amount.toString(), "จำนวนวันที่ลา");
                //           if (res != null) {
                  ...
                  onTap: (readonly)
                      ...
                      : () async {
                          var res = await Navigator.pushNamed(context, '/util103',
                              arguments: {'list': AppStyle().session['company']['training_type'], 'key': 'name', 'select': training_type});
                          if (res != null) {
                            var res2 = res as Map<String, dynamic>;
                            training_type = res2['name'];
                            obj['doc']['data']['training_type'] = training_type;
                            setState(() {});
                          }
                        },
                ...
                TextField(
                  ...
                  onChanged: (val) {
                    setState(() {
                      training_remark = remarkController.text;
                  ...
                  onTap: (readonly)
                      ...
                      : () async {
                          ...
                          if (image != null) {
                            ...
                            final postImagesRef =
                                storageRef.child("users/" + AppStyle().session['user'].uid + "/images/" + DateFormat("yyyyMM").format(DateTime.now()) + "/train_" + image.name);
                            try {
                        ...
                        child: ListTile(
                          onLongPress: () {
                            ...
                            FirebaseFirestore.instance.collection('inbox').doc("${obj['doc']['id']}-${obj['doc']['data']['approver1']}").set({
                              ...
                              'title':
                                  "${AppStyle().session['company']['members'][obj['doc']['uid']]['userinfo']['displayName'] ?? AppStyle().session['company']['members'][obj['doc']['uid']]['userinfo']['email']}",
                              'subtitle': '${AppStyle().formatCurrency.format(obj['doc']['data']['expense_amount'])} (${obj['doc']['data']['training_type']})',
                              'status': obj['doc']['status'],
                              'status_color': '',
                            });
                          },
